...
void abastecimentoBomba(float totalIn, float litrosIn) {
    ...
    do {
        ...
        ssdDigit((((int) (cont/100)) % 10), 0);
        ssdDigit((((int) (cont/10)) % 10), 1);
        ssdDigit((((int) (cont/1)) % 10), 2);
        ssdDigit((((int) (cont/0.1)) % 10), 3);
    ...
    lcdCommand(0x80);
    lcdString("Preco: R$ ");
    lcdChar((((int) (totalIn/100)) % 10) + 48);
    lcdChar((((int) (totalIn/10)) % 10) + 48);
    lcdChar((((int) (totalIn/1)) % 10) + 48);
    lcdChar(',');
    lcdChar((((int) (totalIn/0.1)) % 10) + 48);
    lcdCommand(0xC0);
    lcdString("Litros: ");
    ...
    serial_tx((((int) (totalIn/100)) % 10) + 48);
    serial_tx((((int) (totalIn/10)) % 10) + 48);
    serial_tx((((int) (totalIn/1)) % 10) + 48);
    serial_tx(',');
    serial_tx((((int) (totalIn/0.1)) % 10) + 48);
    serial_tx_str("\r\nLitros: \r");
